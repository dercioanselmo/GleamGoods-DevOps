...
{{- printf "%s-%s" "frontend" .Chart.Version | replace "+" "_" | trunc 63 | trimSuffix "-" }}
{{- end }}
...
{{- default (include "frontend.fullname" .) .Values.configMap.name }}
{{- else }}
...
{{- $metricsAnnotations := ternary .Values.metrics.podAnnotations (dict) .Values.metrics.enabled }}
